...
const labelsFirst = ["Python", "SQL", "Pandas", "Tableau", "Power BI"];
      ...
      <div className="skills-container">
        ...
        <div className="skills-grid">
          <div className="skill">
            ...
            <p>
              I specialize in turning complex datasets into actionable insights
              using SQL, Python, and modern BI tools. I have experience working
              across domains such as equity markets, logistics, and user
              engagement analytics, delivering dashboards and visual reports to
